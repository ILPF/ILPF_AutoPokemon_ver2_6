/*************************************************
ILPF_AutoPokemon_ver2_6.ino

Copyright (c) 2021/09/27 ILPF
  ...
  if(select==1){
    while(s<b){
      ...
      while(i<n){
        ...
        while((j<5)&&(i<n)){
          led_binarycount(n-i) ;
          GettingEgg_hashinoma() ;
          Bicycle_hashinoma(1300) ;
          i++ ;
          j++ ;
        }
        OpenPokemonBox() ;
